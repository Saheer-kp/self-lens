        ...
        <div class="col-lg-6">
          <div class="login-form">
            <div class="brand">
              ...
              <p>Welcome! Please fill the form to register.</p>
            </div>
              ...
              <div class="mb-3">
                <div class="input-group">
                  ...
                  <input
                    ...
                    :class="{
                      'is-invalid':
                        touched.confirm_password && errors.passwordConfirm,
                    }"
                    placeholder="Password"
...
const togglePasswordVisibility = (field) => {
  ...
  else showpasswordConfirm.value = !showpasswordConfirm.value;
};
...
const validateName = (name) => {
  ...
  if (name && name.length > 20)
    return "Name must not be more than 20 charactors";
  return "";
};
...
const isFormValid = computed(() => {
  console.log("from valid email", emailError.value);
  console.log("from valid pass", passwordError.value);
  console.log("from valid name", nameError.value);

  console.log("from valid confirm", passwordConfirmError.value);

  return (
    !emailError.value && !passwordError.value && !nameError.value,
...
const validateField = (field, value) => {
  if (touched.value[field]) {
    if (field === "name") errors.value.name = validateName(value);
    if (field === "email") errors.value.email = validateEmail(value);
    if (field === "password") errors.value.password = validatePassword(value);
    if (field === "confirm_password")
      errors.value.password = validatepasswordConfirm(value);
  }
};
...
const handleRegister = async () => {
  ...
  touched.value.confirm_password = true;
  ...
  errors.value.passwordConfirm = validatepasswordConfirm(passwordConfirm.value);
